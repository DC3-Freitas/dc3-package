...
SAVED_PERFECT_MD_DIR = os.path.join(BASE_DIR, "saved_pretrained_data", "perfect_lattices", "md_results")
SAVED_PERFECT_FEAT_DIR = os.path.join(BASE_DIR, "saved_pretrained_data", "perfect_lattices", "features")
SAVED_SYNTH_FEAT_DIR = os.path.join(BASE_DIR, "saved_pretrained_data", "synthetic_data_features")
SAVED_ML_MODELS_DIR = os.path.join(BASE_DIR, "saved_pretrained_data", "ml_info", "models")
...
SAVED_FULL_MODEL_PATH = os.path.join(BASE_DIR, "saved_pretrained_data", "dc3_full_model.pth")
